...
@endif
    ...
    <h2 class="text-gray-900 font-bold">Data Kategori</h2>
        <div class="bg-white mt-5 p-5 rounded-lg overflow-x-auto">
            <div class="flex flex-col md:flex-row justify-between">    
                <div class="text-left mb-4 md:mb-0"> 
                    @if(Auth::user()->role === 'admin')
                    <a href="/input-kategori" class="text-sm inline-block bg-gray-700 hover:bg-gradient-to-r hover:from-indigo-500 hover:via-cyan-500 hover:to-sky-500 text-white mt-2 md:mt-0 md:mr-2 px-2 py-2 min-w-max flex-shrink-0 transition-colors duration-300"><i class="ri-add-fill"></i> Input Kategori</a>
                    @endif
                    <a  class="text-sm inline-block bg-gray-700 hover:bg-gradient-to-r hover:from-indigo-500 hover:via-cyan-500 hover:to-sky-500 text-white mt-2 md:mt-0 md:mr-2 px-2 py-2 min-w-max flex-shrink-0 transition-colors duration-300" href="/excel/kategori"><i class="ri-file-excel-line"></i> Export Excel</a>
                </div>
