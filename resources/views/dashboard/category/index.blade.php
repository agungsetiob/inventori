        ...
        <div class="bg-white mt-5 p-5 rounded-lg">
            <div class="flex justify-between">
                <div class="text-left">
                    ...
                    <a href="/input-kategori" class="text-sm bg-gray-700 text-white inline-block mt-2 px-2 py-1"><i class="ri-add-fill"></i> Input Kategori</a>
                    @endif
                    <a  class="text-sm bg-gray-700 text-white inline-block mt-2 px-2 py-1" href="/excel/kategori"><i class="ri-file-excel-line"></i> Export Excel</a>
                </div>
