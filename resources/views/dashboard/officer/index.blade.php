    ...
    <div class="container px-4">
        <div class="bg-white mt-5 p-5 rounded-lg">
            <div class="flex justify-between">
                <div class="text-left">
                    <h2 class="text-gray-600 font-bold">Data Akun</h2>
                    <a href="/input-petugas" class="text-sm bg-gray-700 text-white block mt-2 px-2 py-1"><i class="ri-add-fill"></i> Tambah Akun</a>
                </div>
