...
@endif
    ...
    <h2 class="text-gray-900 font-bold">Data Akun</h2>
        <div class="bg-white mt-5 p-5 rounded-lg overflow-x-auto">
            <div class="flex flex-col md:flex-row justify-between">
                <div class="text-left mb-4 md:mb-0">
                    <a href="/input-petugas" class="text-sm inline-block bg-gray-700 
                    ...
                    min-w-max flex-shrink-0 transition-colors duration-300"><i class="ri-add-fill"></i> Tambah Akun</a>
                </div>
