...
<body class="bg-slate-100" style="background-image: url('img/octagon.png'); background-size: cover; background-position: center;">
    <div class="h-[100vh]">
      <div class="container w-full relative flex justify-center">
        <div class="bg-white p-6 rounded-lg mx-auto w-96 md:w-1/4 absolute top-20">
          <div class="text-center">
            <img
              src="https://rsud.tanahbumbukab.go.id/storage/logors.png"
              alt="logo"
              class="w-10 h-10 rounded mx-auto block object-cover"
            />
            <p class="text-sm text-slate-600 mt-2 font-semibold">
              RSUD dr. H. Andi Abdurrahman Noor
            </p>
            <p class="font-bold text-xl mt-5">Login to Inventori</p>
          ...
          <div class="mt-10">
            ...
            <form action="{{route('login')}}" method="post">
              ...
              <button
                class="bg-blue-700 text-white text-center w-full mt-5 py-2 text-sm" type="submit"
              >
                Login <i class="ri-key-2-fill"></i>
              </button>
